 ...
 * @param event
 */
export function updateUniswapDayData(entity: Entity): UniswapDayData {
  let blockTimestamp = entity.getBigInt('blockTimestamp');
  let uniswap = Factory.load(FACTORY_ADDRESS.toHex()) as Factory;
...
export function updatePoolDayData(entity: Entity): PoolDayData {
  let blockTimestamp = entity.getBigInt('blockTimestamp');
...
export function updatePoolHourData(entity: Entity): PoolHourData {
  let blockTimestamp = entity.getBigInt('blockTimestamp');
  let poolAddress = entity.getBytes('poolAddress');
...
export function updateTokenDayData(
  ...
  let blockTimestamp = event.getBigInt('blockTimestamp');
  let timestamp = blockTimestamp.toI32();
  let dayID = timestamp / 86400;
  let dayStartTimestamp = dayID * 86400;
